...
#if using termux
plt.savefig('./figs/ee18btech11048/ee18btech11048_2.pdf')
plt.savefig('./figs/ee18btech11048/ee18btech11048_2.eps')
subprocess.run(shlex.split("termux-open ./figs/ee18btech11048/ee18btech11048_2.pdf"))
#else
#plt.show()
